        ...
        28688: function(e, r, a) {
            ...
            function E(e) {
                for (var r = 1; r < arguments.length; r++) {
                    ...
                    r % 2 ? C(Object(a), !0).forEach((function(r) {
                        (0, n.Z)(e, r, a[r])
                    })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(a)) : C(Object(a)).forEach((function(r) {
                        Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(a, r))
                    }))
                }
                return e
            }
            var A = g()(" top-[-50px] bg-[#ffffff] border-solid border-t-[256px] border-r-[256px] border-r-transparent border-t-transparent border-b-[256px] border-b-transparent border-l-[0] border-l-[#ffffff]", " dark:bg-[#2b2b2b] dark:border-r-[#2b2b2b] dark:border-l-[256px]"),
                B = g()("".concat(A, " translate-x-[29%] rotate-45 dark:translate-x-[-19%] dark:translate-y-[-50%] dark:rotate-45")),
                N = g()("".concat(A, " translate-x-[35%] rotate-45 dark:translate-x-[-25%] dark:translate-y-[-50%] dark:rotate-45"));
            var L = "nav-premium",
                S = "nav-shop-premium",
                R = "navbar-dropdown-context",
                T = "study-plan-card";
            t = {}, (0, n.Z)(t, L, "lp_pl"), (0, n.Z)(t, S, "nb_npl"), (0, n.Z)(t, R, "um_pl"), (0, n.Z)(t, T, "sp_cd");
            var G = "text-border-tertiary dark:text-border-tertiary",
                M = "text-text-secondary dark:text-text-secondary",
                F = "text-text-primary dark:text-text-primary",
                P = "bg-fill-tertiary dark:bg-fill-tertiary",
                O = "bg-gray-60 dark:bg-gray-60",
                H = "bg-layer-02 dark:bg-layer-02",
                j = "bg-layer-01 dark:bg-layer-01",
                D = "border-border-tertiary dark:border-border-tertiary",
                U = "border-text-primary dark:border-text-primary",
                Z = "hover:text-text-secondary dark:hover:text-text-secondary",
                Q = "hover:text-text-primary dark:hover:text-text-primary",
                I = "hover:bg-fill-secondary dark:hover:bg-fill-secondary",
                Y = E(E({}, {
                ...
                _ = {
                    ...
                    navItemPrimary: "".concat(Y.label2),
                    navItemBrandOrange: "!text-brand-orange border-brand-orange",
                    navItemHover: Y.label1Hover,
                    ...
                    menuItems: "flex flex-col absolute top-[36px] z-dropdown rounded-lg p-2 overflow-auto focus:outline-none text-sm ".concat(V.commandBar),
                    menuItemsBg: Y.bgOverlay3,
                    menuItem: "cursor-pointer select-none relative h-8 py-1.5 px-2 whitespace-nowrap",
                    menuItemText: Y.label1,
                    menuItemHover: "".concat(Y.fill4Hover, " rounded"),
                ...
                K = function() {
                    return b.createElement("div", {
                        ...
                        className: "h-42 absolute w-full opacity-20 ".concat(B)
                    }), b.createElement("div", {
                        className: "h-42 absolute w-full opacity-50 dark:opacity-20  ".concat(N)
                    }))
                },
                J = b.forwardRef((function(e, r) {
                    return b.createElement("svg", Object.assign({
                        xmlns: "http://www.w3.org/2000/svg",
                        viewBox: "0 0 24 24",
                        width: "1em",
                ...
                X = function(e) {
                    ...
                    e && e > a && (r = function(e) {
                        ...
                        return r < 1 ? "Plus \u4f1a\u5458\u4e0d\u8db3 1 \u5929 " : "Plus \u4f1a\u5458\u5269\u4f59 ".concat(r, " \u5929 ")
                    }(Math.round((e - a) / 1e3)));
                    return r
                },
                $ = function(e) {
                    var r = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                    return "".concat(r ? "" : "/u", "/").concat(e)
                },
                ee = function(e) {
                    var r = e.noPremiumLink,
                        a = e.noPremiumClick,
                        t = e.isEN,
                        l = e.userData,
                        d = l.isPremium,
                    ...
                    return b.createElement("div", {
                        ...
                        href: $(v || "", t),
                        className: g()("flex items-center text-xl font-semibold ".concat(Y.label1Hover), Y.label1),
                        translate: "no"
                    }, u, c && b.createElement("span", {
                        className: g()("ml-2 inline")
                    }, b.createElement("img", {
                        alt: c,
                        src: c,
                        className: "h-[20px]"
                        ...
                        className: g()(Y.label3, "whitespace-nowrap")
                    }, t ? b.createElement("span", {
                        className: "text-brand-orange"
                    }, "Premium user") : X(s || 0)), !t && b.createElement("a", {
                        onClick: a || void 0,
                        className: g()("hover:text-brand-orange ml-1 whitespace-nowrap")
                    }, "\u7eed\u8ba2")) : m, !t && b.createElement("div", {
                        className: g()("flex items-center space-x-1")
                    }, b.createElement(J, {
                        className: "h-4 w-4"
                    }), b.createElement("a", {
                        href: "/coupons"
                ...
                re = function(e) {
                    var r = e.children,
                        ...
                        t = (0, b.useCallback)((function() {
                            return a.track && a.track()
                        }), [a.track]);
                    return b.createElement("a", {
                        href: a.url,
                        onClick: t,
                        target: "__blank",
                        className: g()(P, I, "flex h-20 w-20 shrink-0 flex-col items-center justify-center rounded-[13px]")
                    }, r)
                },
                ae = function(e) {
                    var r = e.categories;
                    return b.createElement("div", {
                        className: g()("flex shrink-0 justify-between space-x-2 overflow-x-auto px-4 pb-3 md:grid md:grid-cols-3 md:gap-3 md:space-x-0 md:px-0 md:pb-0")
                    }, r.map((function(e, r) {
                        return b.createElement(re, {
                            key: r,
                            category: e
                        }, b.createElement("div", {
                            className: g()("relative mb-2 mt-3 h-9 w-10")
                        }, b.createElement("img", {
                            alt: e.key,
                            src: e.img,
                            className: "w-full object-cover"
                        })), b.createElement("div", {
                            className: g()(M, "mb-2 text-xs")
                        }, e.name))
                    })))
                },
                te = function(e) {
                    ...
                    return b.createElement(b.Fragment, null, r && b.createElement("div", {
                        className: g()("leading-none", t ? Y.labelMessageDanger : M)
                ...
                le = function(e) {
                    var r = e.href,
                        ...
                        i = e.useFragmentWarp,
                        k = e.rightChild,
                        s = g()(o ? Y.labelMessageDanger : M, o ? W.labelMessageDanger : Z, !d && !i && Y.fill4Hover, "rounded cursor-pointer flex items-center py-3 space-x-6 px-2 md:space-x-3 md:py-[10px]"),
                        c = i ? "div" : "li";
                    return b.createElement(b.Fragment, null, r ? function(e, r, a, t, l) {
                        var d = e.target,
                            o = e.icon,
                            n = e.content,
                            i = e.onClick,
                            g = t ? b.Fragment : "li";
                        return b.createElement(g, null, b.createElement("a", {
                            href: r,
                            onClick: i,
                            target: d,
                            className: a
                ...
                ke = b.forwardRef((function(e, r) {
                    return b.createElement("svg", Object.assign({
                        ...
                        result: "shape"
                    }), b.createElement("feColorMatrix", { in: "SourceAlpha",
                        result: "hardAlpha",
                ...
                ve = b.forwardRef((function(e, r) {
                    return b.createElement("svg", Object.assign({
                        ...
                        fill: "none",
                        ref: r
                    }, e), b.createElement("g", null, b.createElement("g", null, b.createElement("path", {
                ...
                he = b.forwardRef((function(e, r) {
                    return b.createElement("svg", Object.assign({
                        ...
                        fill: "none",
                        ref: r
                    }, e), b.createElement("g", null, b.createElement("path", {
                    ...
                    var r = (0, b.useState)(null),
                        ...
                        s = function() {
                            if (a && i) {
                                ...
                                i.style.top = e.top + "px", i.style.left = e.left - 280 + "px", i.style.zIndex = "60", o(!0)
                            }
                        },
                        c = function() {
                            o(!1)
                        };
                    return e.child ? b.createElement(b.Fragment, null, b.createElement("div", {
                        ref: t,
                        onMouseEnter: s,
                        onMouseLeave: c
                    }, b.createElement(le, Object.assign({}, e, {
                        useFragmentWarp: !0,
                        className: g()(Y.fill4Hover),
                        rightChild: b.createElement(J, {
                            className: "h-[14px] w-[14px]"
                        })
                    }))), (0, u.createPortal)(b.createElement("div", {
                        ref: k,
                        className: g()(" absolute w-[280px] mt-[-60px] pr-4", {
                            "display-none": !d
                        }),
                        onMouseEnter: s,
                        onMouseLeave: c
                    }, b.createElement("div", {
                        className: g()("w-[264px] rounded-[13px] p-4", H, V.dropdown)
                    }, e.child.map((function(r, a) {
                        var t = r.href ? "a" : "div";
                        return b.createElement(t, {
                            key: a,
                            className: g()("flex cursor-pointer items-center space-x-3 rounded px-2 py-[10px]", Y.fill4Hover, r.useDangerous ? Y.labelMessageDanger : M, r.className),
                            href: r.href,
                            onClick: r.onClick
                        }, e.useChildActive && b.createElement(ue, {
                            className: g()(F, "h-[18px] w-[18px] opacity-0", {
                                "opacity-100": r.isActive
                            })
                        }), r.icon && b.createElement("div", {
                            className: g()("leading-none", r.useDangerous ? Y.labelMessageDanger : M)
                        }, r.icon), b.createElement("div", {
                            className: "grow text-left"
                        }, r.content))
                    })))), document.body)) : null
                ...
                pe = function(e) {
                    var r = (0, b.useState)(!1),
                        ...
                        t = r[1];
                    return e.child ? b.createElement(b.Fragment, null, b.createElement("div", {
                        className: g()("flex w-full items-center justify-between rounded-[13px] pr-2"),
                        onClick: function() {
                            return t(!a)
                        }
                    }, b.createElement(le, Object.assign({}, e, {
                        useFragmentWarp: !0,
                        className: g()(Y.fill4Hover, "w-full"),
                        rightChild: b.createElement(ie, {
                            className: g()("ml-0.5 h-[14px] w-[14px] transition-[transform]", M, {
                                "rotate-180": a
                            }),
                            "aria-hidden": "true"
                        })
                    }))), b.createElement(k.u, Object.assign({
                        show: a,
                        as: b.Fragment
                    }, ye), b.createElement("ul", {
                        className: g()("m-0 ml-4 mt-1 p-0 outline-none"),
                        onClick: function(e) {
                            return e.stopPropagation()
                        }
                    }, e.child.map((function(r, a) {
                        return b.createElement(le, Object.assign({
                            key: a
                        }, r, {
                            rightChild: e.useChildActive ? b.createElement(ue, {
                                className: g()(F, "h-[18px] w-[18px] opacity-0", {
                                    "opacity-100": r.isActive
                                })
                            }) : null
                ...
                fe = function(e) {
                    return b.createElement(b.Fragment, null, b.createElement("li", {
                        className: "display-none group relative md:block"
                    }, b.createElement(me, Object.assign({}, e))), b.createElement("li", {
                        className: "md:display-none block"
                    }, b.createElement(pe, Object.assign({}, e))))
                },
                xe = function(e) {
                    var r = e.actions;
                    return b.createElement("ul", {
                        ...
                        return e.child ? b.createElement(fe, Object.assign({
                            key: r
                        }, e)) : b.createElement(le, Object.assign({
                            key: r
                        }, e))
                    })))
                };
            ! function() {
                if ("undefined" !== typeof window && "undefined" !== typeof history) {
                    var e = history.pushState,
                        r = history.replaceState;
                    history.pushState = function() {
                        for (var r = arguments.length, a = new Array(r), t = 0; t < r; t++) a[t] = arguments[t];
                        e.apply(history, a), window.dispatchEvent(new Event("pushstate")), window.dispatchEvent(new Event("locationchange"))
                    }, history.replaceState = function() {
                        for (var e = arguments.length, a = new Array(e), t = 0; t < e; t++) a[t] = arguments[t];
                        r.apply(history, a), window.dispatchEvent(new Event("replacestate")), window.dispatchEvent(new Event("locationchange"))
            ...
            var we = function(e) {
                    var r, a = e.className,
                        ...
                        u = e.noPremiumClick,
                        v = e.noPremiumLink,
                        h = "flex absolute top-9 z-nav z-nav mt-1 rounded-[13px] p-4 focus:outline-none ".concat(V.modal),
                        m = t.avatar,
                        y = t.isPremium;
                    return b.createElement("div", {
                        className: "relative"
                    }, b.createElement(s.v, null, b.createElement(s.v.Button, {
                        className: g()(_.menuButton)
                    }, b.createElement("span", {
                        id: "navbar_user_avatar",
                        className: g()("relative ml-1 h-6 w-6", a),
                        onClick: i
                    }, m ? b.createElement("img", {
                        src: m,
                        alt: "avatar",
                        ...
                        as: b.Fragment
                    }, _.popoverTransition), b.createElement(s.v.Items, {
                        id: "web-user-menu",
                        className: g()(h, _.menuItemsBg, "max-h-[calc(100vh-100px)] overflow-y-auto", (r = {}, (0, n.Z)(r, "-right-2", c), (0, n.Z)(r, "left-0 md:-left-64 ", !c), r))
                    }, b.createElement(s.v.Item, null, b.createElement(b.Fragment, null, y && b.createElement(K, null), b.createElement("div", {
                        className: g()("relative flex w-[264px] flex-col")
                    }, b.createElement(ee, {
                        userData: t,
                        isEN: l,
                        noPremiumLink: v,
                ...
                Ne = function(e) {
                    ...
                    return b.createElement("a", {
                        href: "/",
                        onClick: t,
                        className: g()("mb-0.5 flex items-center", r)
                    }, b.createElement("span", {
                        className: g()("display-none h-[22px] dark:flex")
                    }, b.createElement(l, {
                        className: "h-full w-auto max-w-none"
                    })), b.createElement("span", {
                        className: g()("dark:display-none flex h-[22px]")
                    }, b.createElement(d, {
                        className: "h-full w-auto max-w-none"
                    })))
                },
                Le = function(e) {
                    ...
                    return b.createElement("li", {
                        className: g()("relative flex h-full items-center text-sm ", (0, n.Z)({
                            "nav-li-after": t
                        }, U, t), a),
                        onClick: l
                    }, r)
                ...
                Se = function(e) {
                    var r, a, t = e.basePath,
                        l = e.href,
                        d = e.activeStateDisabled,
                        o = e.useBrandOrange,
                        i = e.className,
                        k = e.children,
                        s = e.rootClassName,
                    ...
                    (0, b.useEffect)((function() {
                        y(function() {
                            var e = v || "";
                            return e || (e = "undefined" === typeof window ? "" : window.location.pathname), !d && (!(!l || !e.startsWith(l)) || !!t && (Array.isArray(t) ? t.some((function(r) {
                                return e.startsWith(r)
                            })) : e.startsWith(t)))
                        }())
                    }), [v]);
                    var p = (0, b.useCallback)((function(e) {
                            e.preventDefault();
                            var r = "string" === typeof l ? l : "";
                            u ? u(r) : window.location.href = r
                        }), []),
                        f = g()(_.navItem, Q, (r = {}, (0, n.Z)(r, "font-medium ".concat(F), m), (0, n.Z)(r, M, !m), r)),
                        x = g()(_.navItem, _.navItemBrandOrange),
                        w = g()(i, "relative whitespace-nowrap", Q, (a = {}, (0, n.Z)(a, x, o), (0, n.Z)(a, f, !o), a));
                ...
                Te = function(e) {
                    var r = e.childMenus,
                        a = e.parentName,
                        t = e.useBrandOrange,
                        l = t ? g()(_.menuItem, _.menuItemHover, _.navItemBrandOrange, "flex items-center") : g()(_.menuItem, _.menuItemHover, M, Q, "flex items-center");
                    return b.createElement(s.v, null, b.createElement("span", {
                        className: g()(_.menuButton, t ? _.navItemBrandOrange : "")
                    }, b.createElement(s.v.Button, {
                        as: "button",
                        className: "contents"
                    }, a, " ", b.createElement(ie, {
                        className: g()("ml-1 h-[14px] w-[14px]"),
                        "aria-hidden": "true"
                    }))), b.createElement(k.u, Object.assign({
                        as: b.Fragment
                    }, _.dropdownTransition), b.createElement(s.v.Items, {
                        as: "ul",
                        className: g()(_.menuItems, _.menuItemsBg)
                    }, r.map((function(e, r) {
                        var a = e.href ? "a" : "span";
                        return b.createElement(s.v.Item, {
                            key: r,
                            as: "li"
                        }, b.createElement(a, {
                            href: e.href,
                ...
                Ge = function(e) {
                    ...
                    return b.createElement("button", {
                        ...
                        className: "relative flex h-[40px] w-[40px] transform items-center justify-center overflow-hidden rounded-full bg-slate-700 shadow-md ring-0 ring-gray-300 ring-opacity-30 transition-all duration-200"
                    }, b.createElement("div", {
                        ...
                        className: g()("h-[2px] w-7 origin-left scale-y-75 transform rounded-[1px] transition-all duration-300", O, (0, n.Z)({}, "translate-x-10", t))
                    }), b.createElement("div", {
                        className: g()("h-[2px] w-7 scale-y-75 transform rounded-[1px] transition-all delay-75 duration-300", O, (0, n.Z)({}, "translate-x-10", t))
                    }), b.createElement("div", {
                        className: g()("h-[2px] w-7 origin-left scale-y-75 transform rounded-[1px] transition-all delay-150 duration-300", O, (0, n.Z)({}, "translate-x-10", t))
                    }), b.createElement("div", {
                        className: g()("absolute top-2.5 flex  transform items-center justify-between transition-all duration-300 ", (0, n.Z)({}, "w-0 -translate-x-10", !t))
                    }, b.createElement("div", {
                        className: g()("absolute h-[2px] w-5 rotate-0 transform rounded-[1px] transition-all delay-100 duration-300", O, (0, n.Z)({}, "rotate-45", t))
                    }), b.createElement("div", {
                        className: g()("absolute h-[2px] w-5 -rotate-0 transform rounded-[1px] transition-all delay-100 duration-300", O, (0, n.Z)({}, "-rotate-45", t))
                    })))))
                },
                Me = function(e) {
                    ...
                    return b.createElement(b.Fragment, null, b.createElement("div", {
                        ...
                        className: g()("z-overlay fixed left-0 right-0 top-0 h-full min-h-[300px] w-full overflow-y-auto", j)
                    }, r)))
                },
                Fe = function(e) {
                    var r = e.rightChild,
                        ...
                        t = e.className,
                        l = e.US_EN_LOGO,
                        d = e.mobileMenuChildren,
                        o = e.useMobilePaddingTop,
                        i = e.isFull,
                        k = e.routLinks,
                        s = e.onNavLinkClick,
                        c = e.routerPathname,
                        ...
                        m = (0, b.useCallback)((function(e) {
                            s && s(e);
                            var r = !!k && k.routers.some((function(r) {
                                return e.startsWith(r)
                            }));
                            k && r ? k.routerAction(e) : window.location.href = e
                        }), [k]),
                        y = (0, b.useCallback)((function(e) {
                            s && s(e + "_logo_home")
                        }), [k]);
                    return (0, b.useEffect)((function() {
                        return h(c)
                    }), [c]), (0, b.useEffect)((function() {
                        if (!c) {
                            var e = function() {
                                return h("undefined" === typeof window ? "" : window.location.pathname)
                            };
                    ...
                    }), []), b.createElement(b.Fragment, null, b.createElement("nav", {
                        id: "leetcode-navbar",
                        className: g()("fixed left-0 right-0 top-0 flex h-[50px] w-full items-center border-b-[1px] border-solid md:relative", D, t, "nav-bar-container")
                    }, b.createElement("div", {
                        className: g()("display-none m-auto h-[50px] w-full items-center justify-center px-6 md:flex", (0, n.Z)({}, "max-w-[1200px]", !i))
                    }, b.createElement(Ne, {
                        IS_LCUS: l,
                        onClick: function() {
                            return y("web")
                        ...
                        className: g()("relative m-0 flex h-full grow items-center gap-6 self-end p-0")
                    }, a.map((function(e, r) {
                        return e.parentName ? b.createElement(Se, {
                            key: r,
                            rootClassName: g()((0, n.Z)({}, "!ml-6", 0 === r))
                        }, b.createElement(Te, {
                            parentName: e.parentName,
                            useBrandOrange: e.useBrandOrange,
                            childMenus: e.childMenus || []
                        })) : b.createElement(Se, Object.assign({}, e, {
                            linkClick: m,
                            key: r,
                            currentPath: v
                        }))
                        ...
                        className: g()("md:display-none flex h-[50px] w-full items-center justify-between pl-3 pr-[5px]")
                    }, b.createElement(Ne, {
                        IS_LCUS: l,
                        onClick: function() {
                            return y("mobile")
                        }
                    }), b.createElement(Me, null, d))), o && b.createElement("div", {
                        className: "h-[50px] md:h-0"
                    }))
                },
                Pe = function(e) {
                    if (void 0 !== e && null !== e) try {
                        return JSON.parse(e)
                    } catch (r) {
                        return
                    }
                },
                Oe = "undefined" !== typeof window && !!window.localStorage;
            var He, je = b.forwardRef((function(e, r) {
                    return b.createElement("svg", Object.assign({
                        xmlns: "http://www.w3.org/2000/svg",
                        viewBox: "0 0 24 24",
                        width: "1em",
                ...
                De = b.forwardRef((function(e, r) {
                    ...
                    return (0, b.useImperativeHandle)(r, (function() {
                        return o.current
                    })), b.createElement("div", {
                        className: "relative h-full overflow-hidden rounded-md"
                    }, d ? b.createElement("div", {
                        className: "pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 leading-none"
                    }, b.createElement("span", {
                        className: M
                    }, b.createElement(a, {
                        className: "w-5 h-5"
                    }))) : null, b.createElement("input", Object.assign({
                        ref: o,
                        className: g()("block h-full w-full rounded-full border-none py-1.5 pr-9 text-sm outline-none", Y.placeholderLabel4, Y.label1, P, {
                            "pl-3": !d,
                            "pl-9": d
                        })
                    }, t)), !!t.value && b.createElement("div", {
                        className: "absolute inset-y-0 right-0 flex cursor-pointer items-center pr-3"
                    }, b.createElement("span", {
                        onClick: n,
                        className: "text-gray-6 hover:text-gray-7 dark:text-dark-gray-6 hover:dark:text-dark-gray-7 transition-all"
                    }, b.createElement(je, {
                        className: "h-4 w-4"
                    }))))
                })),
                ...
                Ze = function(e) {
                    var r = e.children,
                        a = e.className,
                        t = (0, l.Z)(e, p);
                    return b.createElement(Ue, Object.assign({
                        className: g()("items-center justify-center", a)
                    }, t), r)
                },
                Qe = function(e) {
                    var r = e.children,
                        ...
                        t = (0, l.Z)(e, f);
                    return b.createElement(Ue, Object.assign({
                        className: g()("items-center justify-between", a)
                    }, t), r)
                },
                Ie = [],
                Ye = b.forwardRef((function(e, r) {
                    var a = e.className,
                        t = e.inputBlur,
                        l = e.onSearchChange,
                        n = e.useEnPlaceHolder,
                        i = function(e, r, a) {
                            var t = (0, b.useState)((function() {
                                    if (!Oe) return r;
                                ...
                                i = o[1],
                                g = (0, b.useRef)(r),
                                k = (0, b.useCallback)((function(r, a) {
                                    try {
                                        d((function(t) {
                                            var l = r instanceof Function ? r(t) : r;
                                            return a && a.skipStorage || !Oe || (void 0 === l ? localStorage.removeItem(e) : localStorage.setItem(e, JSON.stringify(l))), l
                                        }))
                                    } catch (t) {}
                                }), [e]);
                            return (0, b.useEffect)((function() {
                                if (Oe) {
                                    var r = localStorage.getItem(e),
                                        t = Pe(r);
                                    (a && a.writeIfNotExists ? k : d)(t || g.current), i(!0)
                                }
                            }), [e, a, d, k]), [l, k, n]
                        }("GlobalSearchHistory", Ie),
                        k = (0, o.Z)(i, 2),
                        s = k[0],
                        c = k[1],
                    ...
                    var f = (0, b.useState)(!1),
                        x = f[0],
                        w = f[1],
                        C = (0, b.useCallback)((function(e) {
                            p(e.target.value)
                        }), []),
                        E = (0, b.useCallback)((function(e) {
                            "Enter" === e.key && (u(y), w(!1), y && c((function(e) {
                                return [y].concat((0, d.Z)(e)).slice(0, 8)
                            })))
                        }), [y, c, u]),
                        A = (0, b.useCallback)((function(e) {
                            c((function(r) {
                                return r.slice(0, e).concat(r.slice(e + 1))
                    ...
                    return (0, b.useEffect)((function() {
                        var e = function(e) {
                            L.current && L.current.contains(e.target) || S.current && S.current.contains(e.target) || w(!1)
                        };
                        ...
                        return window.addEventListener("click", e), window.addEventListener("blur", e),
                            function() {
                                window.removeEventListener("click", e), window.removeEventListener("blur", e)
                            }
                    }), [t]), (0, b.useImperativeHandle)(r, (function() {
                        return {
                            focus: function() {
                                v.current && v.current.focus(), setTimeout((function() {
                                    w(!0)
                                }), 300)
                            }
                        }
                        ...
                        ref: L,
                        hidden: !x || 0 == s.length,
                        className: "bg-paper shadow-level1 z-dropdown dark:bg-dark-layer-3 dark:shadow-dark-level1 absolute mt-2 w-full rounded-lg p-2"
                    }, b.createElement(Qe, {
                        className: "text-label-3 dark:text-dark-label-3 h-10 rounded px-3 text-sm font-medium"
                    }, b.createElement("span", null, "\u5386\u53f2\u8bb0\u5f55"), b.createElement(Ze, {
                        onClick: B,
                        className: "text-gray-5 hover:bg-fill-3 dark:text-dark-gray-5 dark:hover:bg-dark-fill-3 h-6 w-6 flex-shrink-0 cursor-pointer rounded transition-all"
                    }, b.createElement(be, {
                        className: "h-4  w-4"
                    }))), s.map((function(e, r) {
                        return b.createElement(Qe, {
                            key: r,
                            className: "text-label-2 hover:bg-fill-4 dark:text-dark-label-2 dark:hover:bg-dark-fill-4 h-10 cursor-pointer rounded px-3 text-sm transition-all",
                            onClick: function() {
                                return N(e)
                            }
                        }, b.createElement(Ze, {
                            className: "rounded-1/2 bg-fill-3 text-gray-6 dark:bg-dark-fill-3 dark:text-dark-gray-6 h-6 w-6 flex-shrink-0"
                        }, b.createElement(de, {
                            className: "h-4 w-4"
                        })), b.createElement("div", {
                            className: g()("text-ellipsis whitespace-nowrap overflow-hidden", "ml-3 flex-shrink-0 flex-grow basis-0")
                        }, e), b.createElement(Ze, {
                            className: "rounded-1/2 text-gray-6 hover:bg-fill-3 dark:text-dark-gray-6 dark:hover:bg-dark-fill-3 h-6 w-6 flex-shrink-0 cursor-pointer",
                            onClick: function(e) {
                ...
                Ve = function(e) {
                    var r, a, t = e.onSearchChange,
                        l = e.useEnPlaceHolder,
                        d = (0, b.useState)(!1),
                        o = d[0],
                        i = d[1],
                        k = (0, b.useRef)(null),
                        s = (0, b.useCallback)((function() {
                            k.current && k.current.focus(), i(!0)
                        }), []);
                    return b.createElement("div", {
                        className: " display-none relative h-8  w-8  [@media(min-width:1000px)]:inline-block",
                        onClick: function(e) {
                            return e.stopPropagation()
                        }
                    }, b.createElement(Ye, {
                        useEnPlaceHolder: l,
                        className: g()(" z-base-2 !absolute right-0  top-0 inline-block h-8 transition-[width] duration-200 ", (r = {}, (0, n.Z)(r, "w-[240px]", o), (0, n.Z)(r, "w-0", !o), r)),
                        inputBlur: function() {
                            return i(!1)
                        },
                        onSearchChange: t,
                        ...
                        className: g()("z-base-1 group group  relative flex h-full w-full  cursor-pointer items-center justify-center rounded transition-all duration-200", Y.fill3Hover, (a = {}, (0, n.Z)(a, "opacity-0", o), (0, n.Z)(a, "opacity-100  delay-100", !o), a)),
                        onClick: s
                    }, b.createElement(ne, {
                        className: g()("h-5 w-5", Q, M)
                    })))
                },
                We = function(e) {
                    var r = e.orientation,
                        ...
                        t = e.className,
                        d = (0, l.Z)(e, x);
                    return "vertical" !== a ? b.createElement("hr", Object.assign({
                        className: g()("border-divider-2 dark:border-dark-divider-2", t)
                    }, d)) : b.createElement("div", Object.assign({
                        className: g()("bg-divider-2 dark:bg-dark-divider-2 h-full w-px", t)
                    }, d))
                },
                qe = function() {
                ...
                ze = function() {
                    ...
                    return "/accounts/signup/?".concat(r)
                },
                _e = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                        r = (0, v.stringify)({
                    ...
                    return "/accounts/login/?".concat(r)
                },
                Ke = function(e) {
                    var r = e.isEN;
                    return b.createElement("div", {
                        className: g()(Y.label1, "border-divider-2 dark:border-gray-7 border-b pb-4 pl-4")
                    }, b.createElement("a", {
                        href: ze()
                    }, b.createElement("a", {
                        className: g()(M)
                    }, r ? "Register" : "\u6ce8\u518c")), b.createElement("span", {
                        className: g()("border-r pl-3")
                    }), b.createElement("a", {
                        href: _e()
                    }, b.createElement("a", {
                        className: g()("pl-3", M)
                ...
                Je = function(e) {
                    var r = e.trigger,
                        ...
                        d = t[1];
                    return b.createElement("li", {
                        className: g()("w-full rounded focus:outline-none"),
                        onClick: function() {
                            return d(!l)
                        }
                    }, b.createElement("div", {
                        className: g()("flex w-full items-center justify-between rounded pr-2", Y.fill4Hover)
                    }, r, b.createElement(ie, {
                        className: g()("ml-0.5 h-[14px] w-[14px]  transition-[transform] ".concat(l && "rotate-180"), M),
                        "aria-hidden": "true"
                    })), b.createElement(k.u, Object.assign({
                        show: l,
                        as: b.Fragment
                ...
                Xe = function(e) {
                    ...
                    return b.createElement(Je, {
                        trigger: b.createElement(le, Object.assign({}, e, {
                            useFragmentWarp: !0
                        }))
                    }, r.map((function(e, r) {
                        return b.createElement(le, Object.assign({
                ...
                $e = function(e) {
                    var r = e.navLinkList;
                    return b.createElement("ul", {
                        className: g()("m-0 p-0 px-4 pt-4 md:px-0"),
                        id: "mobile-nav-links"
                    }, r.map((function(e, r) {
                        return e.childMenus && e.childMenus.length > 0 ? b.createElement(Xe, Object.assign({
                            key: r
                        }, e)) : b.createElement(le, Object.assign({}, e, {
                            key: r
                        }))
                    })))
                },
                er = function() {
                    return b.createElement("div", {
                        ...
                        className: "h-42 ".concat(B, " absolute w-full opacity-20")
                    }), b.createElement("div", {
                        className: "h-42 ".concat(N, " absolute w-full opacity-50 dark:opacity-20")
                    }))
                },
                rr = function(e) {
                    var r = e.userData,
                        ...
                        i = r.isPremium,
                        k = r.isSignedIn;
                    return b.createElement(b.Fragment, null, i && b.createElement(er, null), b.createElement("div", {
                        className: g()("max-h-[calc(100vh - theme('spacing.12'))] border-t-1 relative flex w-full flex-col overflow-y-auto py-4 ".concat(V.dropdown))
                    }, k ? b.createElement(ee, {
                        userData: r,
                        isEN: a,
                        noPremiumLink: n,
                        noPremiumClick: o
                        ...
                        isEN: a
                    }), k && b.createElement(ae, {
                        categories: t
                    }), b.createElement($e, {
                        navLinkList: d
                    }), k && b.createElement(b.Fragment, null, b.createElement(We, {
                        className: g()(G, "mx-4 mt-2")
                    }), b.createElement(xe, {
                        actions: l
                    }))))
                };
            ...
            var ar = function(e) {
                    var r = e.open,
                        a = e.onVisibilityChange,
                        t = (0, b.useRef)(r);
                    return (0, b.useEffect)((function() {
                        r !== t.current && (t.current = r, a && a(r))
                    }), [r, a]), null
                },
                tr = function(e) {
                    var r = e.className,
                        ...
                        S = (0, b.useCallback)((function(e) {
                            if (L.current) {
                                var r = L.current.getBoundingClientRect(),
                                    a = r.x,
                                    t = r.y,
                                    l = r.width,
                                    d = r.height;
                            ...
                            if (L.current) {
                                var e = L.current.getBoundingClientRect(),
                                    ...
                                    d = function(e, r) {
                                        var a = e.x,
                                            ...
                                            i = b.x,
                                            g = b.y;
                                        return i < o / 3 ? g < n / 3 ? [He.TopLeft, b] : g > 2 * n / 3 ? [He.BottomLeft, b] : [He.Left, b] : i > 2 * o / 3 ? g < n / 3 ? [He.TopRight, b] : g > 2 * n / 3 ? [He.BottomRight, b] : [He.Right, b] : g < n / 3 ? [He.TopCenter, b] : g > 2 * n / 3 ? [He.BottomCenter, b] : [He.Center, b]
                                    }({
                                        x: r,
                                        y: a,
                                        width: t,
                                ...
                                switch ((0, o.Z)(d, 1)[0]) {
                                    ...
                                    case He.BottomRight:
                                        S("leftBottom");
                                        break;
                                    case He.BottomCenter:
                                        S("top");
                                        break;
                                    case He.Center:
                                        var n = a + l / 2 < document.body.clientHeight / 2;
                                        S(n ? "bottom" : "top")
                                }
                            }
                        }), [S]),
                        ...
                        H = (0, b.useCallback)((function(e, r) {
                            i && (N.current && clearTimeout(N.current), e !== r && (N.current = setTimeout((function() {
                                e === M.current && (P.current = !0, O())
                            }), y)))
                        }), [y, O, i, M]),
                        j = (0, b.useCallback)((function() {
                            i && (P.current || O(), P.current = !1)
                        }), [O, i]);
                    return (0, b.useEffect)((function() {
                    ...
                    }), [G]), l ? b.createElement(b.Fragment, null, u) : b.createElement(c.J, {
                        className: g()("popover-wrapper inline-block", r)
                    }, (function(e) {
                        var r = e.open,
                            l = e.close;
                        return b.createElement(b.Fragment, null, b.createElement(ar, {
                            open: r,
                        ...
                        }, b.createElement(c.J.Button, {
                            ref: L,
                            as: "div",
                            className: a,
                            onClick: j
                        }, u), b.createElement(k.u, {
                            show: r,
                            as: b.Fragment,
                            enter: "transition ease-out duration-200",
                            enterFrom: "opacity-0 translate-y-1",
                            ...
                            leaveFrom: "opacity-100 translate-y-0",
                            leaveTo: "opacity-0 translate-y-1"
                        }, b.createElement(c.J.Panel, {
                            as: "div",
                            className: g()("fixed w-max rounded z-modal md:block", Y.bgPaper, V.dropdown, {
                                "display-none": !d
                            }, t),
                            style: A.panelStyle,
                            onClick: C ? l : h.Z
                ...
                dr = b.memo((function() {
                    return b.createElement("div", {
                        ...
                        className: "mb-2 h-2 w-1/2 rounded-[2px] ".concat(Y.fill3)
                    }), b.createElement("div", {
                        className: "h-2 w-full rounded-[2px] ".concat(Y.fill3)
                    })))
                })),
                or = {
                ...
                br = function(e) {
                    var r, a = e.currentDayCompleted,
                        t = e.isLoading,
                        l = e.streakCount,
                        d = e.daysSkipped,
                        o = e.dailyQuestionLink,
                        i = e.storePath,
                        k = e.dailyQuestionMedal,
                        s = e.customText,
                        c = void 0 === s ? or : s,
                        u = e.iconClassName,
                        v = e.panelClassName,
                        ...
                        y = e.onStreakCounterClick,
                        p = (0, b.useMemo)((function() {
                            var e = "";
                            return a ? d <= 0 ? e = c.finished : d > 0 && (e = b.createElement("div", null, b.createElement("span", null, d > 1 ? c.missedDaysThisMonth.replace("{{count}}", "".concat(d)) : c.missedOneDayThisMonth), b.createElement("a", {
                                href: i,
                                className: g()("cursor-pointer whitespace-nowrap", Y.labelBlueStandard),
                                onClick: h
                            }, c.buyTimeTravelTicket, " >"))) : e = c.unfinished, b.createElement("div", {
                                className: g()("dark:bg-dark-fill-2 rounded text-sm")
                            }, b.createElement("div", {
                                className: g()("h-[54px] w-[276px] py-2.5 pl-4 pr-2.5", {
                                    "display-none": !t,
                                    block: t
                                })
                            }, b.createElement(dr, null)), b.createElement("div", {
                                className: g()("flex items-center px-[10px] py-[5px]", {
                                    "display-none": t,
                                    block: !t
                                })
                                ...
                                src: k,
                                alt: "DCC Badge",
                                className: g()("mr-4 h-8 w-8 object-cover", {
                                    "opacity-60 mix-blend-luminosity": !a
                                })
                            }), b.createElement("span", {
                                className: Y.label1
                            }, e)))
                    ...
                    return b.createElement(tr, {
                        ...
                        panelClassName: g()("max-w-[276px] px-0 py-0", v),
                        inset: 12,
                        content: p,
                        onVisibilityChange: m
                    }, b.createElement("a", {
                        onClick: y,
                        className: g()("group relative flex h-8 items-center justify-center rounded p-1", Y.fill3Hover, {
                            "cursor-default": a
                        }),
                        href: a ? void 0 : o
                    }, a ? b.createElement(ke, {
                        className: g()("h-[20px] w-[20px]", u)
                    }) : b.createElement(ge, {
                        className: g()("h-[20px] w-[20px]", "".concat(Q, " ").concat(M), u)
                    }), b.createElement("span", {
                        className: g()("mx-1 text-sm font-medium", (r = {}, (0, n.Z)(r, "".concat(Q, " ").concat(M), !a), (0, n.Z)(r, Y.labelBrandOrange, a), r))
                    }, t ? "-" : l)))
                },
                ir = function(e) {
                    var r = e.Component,
                        ...
                        t = (0, l.Z)(e, w);
                    return b.createElement("div", {
                        className: g()(M, Y.fill3Hover, _.navIcon, "group cursor-pointer focus:outline-none", a)
